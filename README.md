...
- [docs(website): update AWS compatibility data](https://github.com/robmorgan/infraspec/pull/182) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (1 day ago)
- [ci: parallelize integration tests by AWS service](https://github.com/robmorgan/infraspec/pull/181) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (4 days ago)
- [feat(terraform): always copy config to temp directory for state isolation](https://github.com/robmorgan/infraspec/pull/180) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (4 days ago)
...
- [vercel/turborepo](https://github.com/vercel/turborepo) ([v2.7.0](https://github.com/vercel/turborepo/releases/tag/v2.7.0), 1 day ago) - Build system optimized for JavaScript and TypeScript, written in Rust
- [robmorgan/infraspec](https://github.com/robmorgan/infraspec) ([v0.1.2](https://github.com/robmorgan/infraspec/releases/tag/v0.1.2), 1 day ago) - ✅ InfraSpec is a tool for testing your AWS infrastructure code in plain English.
...
- [aws/api-models-aws](https://github.com/aws/api-models-aws) - API Models for all public AWS Services (4 days ago)
