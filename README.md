...
- [Single .tsa analysis file: container in the lib, peaks moved from desktop, legacy sidecars migrated](https://github.com/robmorgan/timestretch-rs/pull/35) on [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) (2 days ago)
- [desktop: persisted waveform-peaks cache &#43; async load path](https://github.com/robmorgan/timestretch-rs/pull/34) on [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) (2 days ago)
- [Stage 11: Wide-Range Master Tempo — falsification &#43; live WideKeylock profile](https://github.com/robmorgan/timestretch-rs/pull/33) on [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) (2 days ago)
- [Streaming quality: splice placement &#43; crossover tuning, and three audible boundary/limit-cycle defect fixes](https://github.com/robmorgan/timestretch-rs/pull/32) on [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) (3 days ago)
- [feat(desktop): steady repaint pacing — twitch-free waveform scrolling on ProMotion](https://github.com/robmorgan/timestretch-rs/pull/31) on [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) (3 days ago)
...
- [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) ([v0.11.0](https://github.com/robmorgan/timestretch-rs/releases/tag/v0.11.0), 1 day ago) - Pure 🦀 Rust audio time-stretching library optimized for electronic dance music.
- [robmorgan/halo](https://github.com/robmorgan/halo) ([v0.1.0](https://github.com/robmorgan/halo/releases/tag/v0.1.0), 4 days ago) - ⭕️ Halo is a DJ app with a built-in lighting console, designed for solo performers who want to deliver modern, immersive experiences.
