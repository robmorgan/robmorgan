...
- [brightfame/metamorph](https://github.com/brightfame/metamorph) - Make batch changes across multiple repos and leverage AI (4 weeks ago)
...
- [Add initial RDS support](https://github.com/robmorgan/infraspec/pull/5) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (4 weeks ago)
- [Batch mvp](https://github.com/brightfame/metamorph/pull/5) on [brightfame/metamorph](https://github.com/brightfame/metamorph) (4 weeks ago)
...
- [robmorgan/halo](https://github.com/robmorgan/halo) ([v0.0.2](https://github.com/robmorgan/halo/releases/tag/v0.0.2), 2 days ago) - ⭕️ Halo is a real-time lighting console, designed to bring modern, immersive experiences into the hands of solo performers
- [cli/cli](https://github.com/cli/cli) ([v2.70.0](https://github.com/cli/cli/releases/tag/v2.70.0), 2 days ago) - GitHub’s official command line tool
...
- [mark3labs/mcp-go](https://github.com/mark3labs/mcp-go) - A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools. (4 weeks ago)
