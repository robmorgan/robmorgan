...
- [feat: wire up extra_packages config to Docker image build](https://github.com/robmorgan/metamorph/pull/10) on [robmorgan/metamorph](https://github.com/robmorgan/metamorph) (1 month ago)
...
- [vercel/turborepo](https://github.com/vercel/turborepo) ([v2.8.21-canary.9](https://github.com/vercel/turborepo/releases/tag/v2.8.21-canary.9), 1 day ago) - Build system optimized for JavaScript and TypeScript, written in Rust
- [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) ([v0.3.0](https://github.com/robmorgan/timestretch-rs/releases/tag/v0.3.0), 1 day ago)
...
- [ghostty-org/ghostling](https://github.com/ghostty-org/ghostling) - A minimum viable terminal emulator built on top of the libghostty C API. Ex minimo, infinita nascuntur. 👻🐣 (2 days ago)
- [davebcn87/pi-autoresearch](https://github.com/davebcn87/pi-autoresearch) - Autonomous experiment loop extension for pi (2 days ago)
