...
- [pr feedback](https://github.com/robmorgan/sws-stocks/pull/3) on [robmorgan/sws-stocks](https://github.com/robmorgan/sws-stocks) (1 day ago)
- [Feedback](https://github.com/robmorgan/sws-stocks/pull/2) on [robmorgan/sws-stocks](https://github.com/robmorgan/sws-stocks) (1 day ago)
...
- [gruntwork-io/terragrunt](https://github.com/gruntwork-io/terragrunt) ([v0.68.2](https://github.com/gruntwork-io/terragrunt/releases/tag/v0.68.2), 1 day ago) - Terragrunt is a flexible orchestration tool that allows Infrastructure as Code written in OpenTofu/Terraform to scale.
- [gruntwork-io/docs](https://github.com/gruntwork-io/docs) ([v1.2.7](https://github.com/gruntwork-io/docs/releases/tag/v1.2.7), 6 days ago) - Gruntwork docs files plus a set of tools to auto-generate a docs website from package markdown files.
...
- [albertogeniola/meross-homeassistant](https://github.com/albertogeniola/meross-homeassistant) - Custom component that leverages the Meross IoT library to integrate with Homeassistant (2 days ago)
- [paultyng/terraform-provider-unifi](https://github.com/paultyng/terraform-provider-unifi) - Terraform provider for Unifi :satellite: (6 days ago)
