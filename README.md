...
- [fix: auto-resolve sync conflicts and preserve existing .gitignore](https://github.com/robmorgan/metamorph/pull/13) on [robmorgan/metamorph](https://github.com/robmorgan/metamorph) (1 week ago)
...
- [vercel/turborepo](https://github.com/vercel/turborepo) ([v2.8.11-canary.4](https://github.com/vercel/turborepo/releases/tag/v2.8.11-canary.4), 1 day ago) - Build system optimized for JavaScript and TypeScript, written in Rust
- [robmorgan/metamorph](https://github.com/robmorgan/metamorph) ([v0.2.1](https://github.com/robmorgan/metamorph/releases/tag/v0.2.1), 1 week ago) - Orchestrate parallel Claude Code Agents that coordinate through Git. ✨
