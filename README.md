...
- [feat(terraform): always copy config to temp directory for state isolation](https://github.com/robmorgan/infraspec/pull/180) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (1 week ago)
- [feat(website): add early access page for Virtual Cloud signups](https://github.com/robmorgan/infraspec/pull/171) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (2 weeks ago)
- [feat(sqs): add SQS queue assertions and step definitions](https://github.com/robmorgan/infraspec/pull/159) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (4 weeks ago)
...
- [vercel/turborepo](https://github.com/vercel/turborepo) ([v2.7.3-canary.0](https://github.com/vercel/turborepo/releases/tag/v2.7.3-canary.0), 3 days ago) - Build system optimized for JavaScript and TypeScript, written in Rust
- [robmorgan/infraspec](https://github.com/robmorgan/infraspec) ([v0.1.2](https://github.com/robmorgan/infraspec/releases/tag/v0.1.2), 1 week ago) - ✅ InfraSpec is a tool for testing your AWS infrastructure code in plain English.
