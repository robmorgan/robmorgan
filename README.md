...
- [docs: remove content](https://github.com/robmorgan/infraspec/pull/199) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (5 days ago)
- [Chore/builtin virtual cloud](https://github.com/robmorgan/infraspec/pull/198) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (5 days ago)
- [feat: Add DJ module with dual-deck playback and beat analysis](https://github.com/robmorgan/halo/pull/72) on [robmorgan/halo](https://github.com/robmorgan/halo) (5 days ago)
- [feat(lambda): add BDD testing support for Lambda functions](https://github.com/robmorgan/infraspec/pull/194) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (6 days ago)
- [fix(rds): reduce DB instance removal delay from 120s to 5s](https://github.com/robmorgan/infraspec/pull/193) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (6 days ago)
...
- [robmorgan/infraspec](https://github.com/robmorgan/infraspec) ([v0.2.2](https://github.com/robmorgan/infraspec/releases/tag/v0.2.2), 5 days ago) - ✅ InfraSpec is a tool for testing your AWS infrastructure code in plain English.
