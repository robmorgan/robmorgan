...
- [robmorgan/metamorph](https://github.com/robmorgan/metamorph) - Orchestrate parallel Claude Code Agents that coordinate through Git. ✨ (4 weeks ago)
...
- [Per-bin spectral flux &#43; streaming WSOLA-PV hybrid overlay](https://github.com/robmorgan/timestretch-rs/pull/3) on [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) (1 day ago)
- [Per-bin spectral flux tracking &#43; streaming WSOLA-PV hybrid overlay](https://github.com/robmorgan/timestretch-rs/pull/2) on [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) (1 day ago)
...
- [vercel/turborepo](https://github.com/vercel/turborepo) ([v2.8.21-canary.9](https://github.com/vercel/turborepo/releases/tag/v2.8.21-canary.9), 2 days ago) - Build system optimized for JavaScript and TypeScript, written in Rust
- [robmorgan/timestretch-rs](https://github.com/robmorgan/timestretch-rs) ([v0.3.0](https://github.com/robmorgan/timestretch-rs/releases/tag/v0.3.0), 2 days ago)
...
- [ghostty-org/ghostling](https://github.com/ghostty-org/ghostling) - A minimum viable terminal emulator built on top of the libghostty C API. Ex minimo, infinita nascuntur. 👻🐣 (3 days ago)
- [davebcn87/pi-autoresearch](https://github.com/davebcn87/pi-autoresearch) - Autonomous experiment loop extension for pi (3 days ago)
- [robmorgan/agentd](https://github.com/robmorgan/agentd) - ✨ A daemon-backed workspace for coding agents - like tmux, but built for AI-native software development. (1 week ago)
