...
- [vercel/turborepo](https://github.com/vercel/turborepo) ([v2.9.19-canary.9](https://github.com/vercel/turborepo/releases/tag/v2.9.19-canary.9), 3 days ago) - Build system optimized for JavaScript and TypeScript, written in Rust
...
- [ghostty-org/ghostling](https://github.com/ghostty-org/ghostling) - A minimum viable terminal emulator built on top of the libghostty C API. Ex minimo, infinita nascuntur. 👻🐣 (3 months ago)
- [davebcn87/pi-autoresearch](https://github.com/davebcn87/pi-autoresearch) - Autonomous experiment loop extension for pi (3 months ago)
