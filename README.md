...
- [docs(website): update AWS compatibility data](https://github.com/robmorgan/infraspec/pull/182) on [robmorgan/infraspec](https://github.com/robmorgan/infraspec) (6 days ago)
...
- [vercel/turborepo](https://github.com/vercel/turborepo) ([v2.7.3-canary.0](https://github.com/vercel/turborepo/releases/tag/v2.7.3-canary.0), 2 days ago) - Build system optimized for JavaScript and TypeScript, written in Rust
- [robmorgan/infraspec](https://github.com/robmorgan/infraspec) ([v0.1.2](https://github.com/robmorgan/infraspec/releases/tag/v0.1.2), 6 days ago) - ✅ InfraSpec is a tool for testing your AWS infrastructure code in plain English.
